...
export default function Home() {
  ...
  return (
    <div className="flex flex-col min-h-screen bg-transparent text-zinc-300 font-sans">
      ...
      <section className="relative min-h-[80svh] min-h-[80vh] sm:min-h-[85vh] lg:min-h-[88vh] flex flex-col items-center justify-end pb-28 sm:pb-52 lg:pb-64 overflow-hidden px-4 text-center z-20 pb-[calc(7rem+env(safe-area-inset-bottom,0px))]">
